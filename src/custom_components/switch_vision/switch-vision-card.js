...
function defaultUiLayout() {
  ...
  return {
    ...
    calibration_button: { show: true, x: 1888, y: 372, width: 138, height: 34, anchor: "top_right" },
    status_panel: {
      show: true,
      x: 345,
      y: 47,
