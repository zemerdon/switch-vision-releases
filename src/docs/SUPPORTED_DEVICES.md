...
| Cisco | Catalyst 3850 | `WS-C3850-12XS-E` | 0 | 12 10G SFP+ | No | No | `faceplates/cisco-3850-12xs.png` | `cisco_3850_12xs` | Community Confirmed Te Member 0 1 12 Link Speed Activity | Community Validated | v2.7.3 |
...
| Ubiquiti | UniFi Switch Enterprise | `USW-Enterprise-8-PoE` | 8 | 2 10G SFP+ | Yes | No | `faceplates/unifi-8-rj45-2sfp.png` | `unifi_8_rj45_2sfp` | Candidate Repeated Evidence | Experimental | v2.0.32 |
| Ubiquiti | UniFi Switch Pro | `USW-Pro-24-PoE` | 24 | 2 10G SFP+ | Yes | No | `faceplates/unifi-24-rj45-2sfp-inline.png` | `unifi_24_rj45_2sfp_inline` | Candidate Media Pending Validation | Experimental | v2.0.32 |
...
| Ubiquiti | UniFi Switch Pro XG | `USW Pro XG 8 PoE` | 8 | 2 10G SFP+ | Yes | No | `faceplates/unifi-8-rj45-2sfp.png` | `unifi_8_rj45_2sfp` | Api Confirmed Connector And Speed | Experimental | v2.0.32 |
...
| Ubiquiti | UniFi Switch Lite 8 PoE | `USW-Lite-8-PoE` | 8 | 0 none | Yes | No | `faceplates/unifi-8rj45.png` | `default_unifi_8_rj45` | Live Api Confirmed Connector And Speed | Experimental | v2.1.16 |
| Ubiquiti | UniFi Dream Machine Pro SE | `UniFi Dream Machine PRO SE` | 9 | 2 10G SFP+ | Yes | No | `faceplates/unifi-9rj45-2sfp.png` | `unifi_9_rj45_2sfp` | Live Api Confirmed Ports 10 11 10G Sfp Plus | Experimental | v2.1.19 |
| Ubiquiti | UniFi Cloud Gateway Ultra | `UCG Ultra` | 5 | 0 none | No | No | `faceplates/unifi-5rj45.png` | `default_unifi_5_rj45` | Not Applicable | Experimental | v2.4.10 |
| Ubiquiti | UniFi Switch 16 PoE 150W | `US 16 PoE 150W` | 16 | 2 Gigabit SFP | Yes | No | `faceplates/unifi-16rj45-2sfp.png` | `unifi_16_rj45_2sfp` | Live Api Confirmed Ports 17 18 1G Sfp | Experimental | v2.4.10 |
...
| Ubiquiti | UniFi Switch Ultra | `USW Ultra` | 8 | 0 none | Yes | No | `faceplates/unifi-8rj45.png` | `default_unifi_8_rj45` | Not Applicable | Experimental | v2.4.10 |
...
| HP | 1810 | `HP ProCurve 1810G-24` | 24 | 2 Gigabit SFP | No | No | `faceplates/24rj45-2sfp.png` | `stock_24rj45_2sfp` | Manufacturer Confirmed Dual Personality Indexes 23 24 Medium Pending | Experimental | v2.4.47 |
...
| Ubiquiti | UniFi Switch 8 150W | `US-8-150W` | 8 | 2 Gigabit SFP | Yes | No | `faceplates/unifi-8-rj45-2sfp.png` | `unifi_8_rj45_2sfp` | Real Hardware Snmp Ports 0 9 0 10 1G Sfp Confirmed | Experimental | v2.7.6 |
| Ubiquiti | UniFi Switch 24 250W | `US-24-250W` | 24 | 2 Gigabit SFP | Yes | No | `faceplates/unifi-24p-rj45-2sfp.png` | `unifi_24p_rj45_2sfp` | Real Hardware Snmp Ports 0 25 0 26 1G Sfp Confirmed | Experimental | v2.3.31 |
| Dell | PowerConnect 5500 | `PowerConnect 5548P` | 48 | 2 10G SFP+ | Yes | No | `faceplates/48rj45-2sfp.png` | `stock_48rj45_2sfp` | Real Hardware Interface Map Confirmed | Experimental | v2.3.24 |
| Zyxel | GS1900 | `GS1900-24E` | 24 | 0 none | No | No | `faceplates/24rj45-2sfp.png` | `stock_24rj45_2sfp` | Not Applicable | Experimental | v2.4.47 |
| Cisco | Catalyst 3750X | `WS-C3750X-48P` | 48 | 2 Gigabit SFP + 2 10G SFP+ | Yes | Yes | `faceplates/48rj45-4sfp.png` | `default_cisco_48_port` | Real Hardware Alias Dedup Mapping Confirmed | Experimental | v2.3.24 |
| Cisco | Catalyst 3750X | `WS-C3750X-48P-S` | 48 | 2 Gigabit SFP + 2 10G SFP+ | Yes | Yes | `faceplates/48rj45-4sfp.png` | `default_cisco_48_port` | Real Hardware C3Kx Alias Dedup Mapping Confirmed | Experimental | v2.4.47 |
| Cisco | Cisco Small Business SG350 | `SG350-20` | 18 | 4 Gigabit SFP | No | No | `faceplates/24rj45-4sfp.png` | `stock_24rj45_4sfp` | Combo Semantics Conservative Pending Medium Validation | Experimental | v2.4.47 |
| HP | 3500yl | `HP J8693A Switch 3500yl-48G` | 48 | 4 Gigabit SFP | Yes | No | `faceplates/48rj45-4sfp.png` | `stock_48rj45_4sfp` | Entity Binding Confirmed Medium Pending | Experimental | v2.4.47 |
| Ubiquiti | UniFi Switch Pro HD | `USW Pro HD 24 PoE` | 24 | 4 10G SFP+ | Yes | No | `faceplates/unifi-24-rj45-4sfp-inline.png` | `unifi_24_rj45_4sfp_inline` | Real Hardware Snmp Ports 0 25 0 28 Confirmed | Experimental | v2.3.24 |
| Ubiquiti | UniFi Switch Aggregation | `USW Aggregation` | 0 | 8 10G SFP+ | No | No | `faceplates/unifi-32sfp.png` | `unifi_32sfp` | Live Api Confirmed Ports 1 8 10G Sfp Plus | Experimental | v2.3.24 |
...
- **Community Validated:** A real user has validated the applicable physical mapping, port selection, LEDs, link/speed behaviour, PoE, optical positions, sensors and rendered alignment.
