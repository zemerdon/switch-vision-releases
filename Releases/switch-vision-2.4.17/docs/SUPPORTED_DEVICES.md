...
| Ubiquiti | UniFi Cloud Gateway Ultra | `UCG Ultra` | 5 | 0 none | No | No | `Pending` | `Pending` | Not Applicable | Experimental | v2.4.10 |
...
| Ubiquiti | UniFi Switch Ultra | `USW Ultra` | 8 | 0 none | Yes | No | `Pending` | `Pending` | Not Applicable | Experimental | v2.4.10 |
