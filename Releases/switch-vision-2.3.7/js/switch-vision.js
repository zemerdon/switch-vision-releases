...
<div class="cv-cal-tools-row cv-cal-style-row">
      ...
      <div class="cv-cal-tools-row cv-cal-style-row">
        ...
        <span class="cv-cal-colour-field"><span>Border colour</span><select class="cv-cal-select" data-cv-field="status2-border-color">${[["rgba(245,248,250,.75)","White"],["#29a8ff","Blue"],["#ffb321","Amber"],["#76ff33","Green"],["#ff5252","Red"],["#000000","Black"]].map(([v,l]) => `<option value="${v}" ${status2Ui.border_color === v ? "selected" : ""}>${l}</option>`).join("")}</select>${customColourControlsHtml("status2-border-color", status2Ui.border_color, "rgba(245,248,250,.75)")}</span>
      </div>
      <div class="cv-cal-tools-row cv-cal-status-row">
        <span class="cv-cal-quick-label">Status Box 2</span>
